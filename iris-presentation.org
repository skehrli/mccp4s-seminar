...
- Parkinson, 2010: CSL must be unified, a common framework s.t. ppl can focus on actually verifying things and not respin metatheory each time
...
- Can update global ghost state using /view shifts/
